...
- [⚙️ Режимы маппинга](#-режимы-маппинга)
...
## 🔍 Что делает оригинал
Сканер **[FunGun] EasyCheatDetector** сканирует систему на наличие следов читов для CS 1.6 (и частично других игр).
...
Проект использует три независимых **маппера**, каждый из которых оставляет в системе определённый "след" для сканера:
### 📁 `UserDirMapper`
